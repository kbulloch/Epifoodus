...
SELECT pg_catalog.setval('cuisines_id_seq', 45, true);
...
SELECT pg_catalog.setval('cuisines_restaurants_id_seq', 20, true);
...
SELECT pg_catalog.setval('restaurants_id_seq', 99, true);
